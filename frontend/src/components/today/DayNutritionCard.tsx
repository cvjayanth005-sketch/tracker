  ...
  return (
    <Card>
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <div className="type-micro font-semibold text-info">Water</div>
          <div className="tabular mt-1 type-title text-[var(--app-ink)]">
            {waterMl === null ? <span className="text-[var(--app-muted)]">—</span> : fmtInt(waterMl)}
            <span className="ml-1 type-caption font-normal text-[var(--app-muted)]">
        ...
        <div className="grid grid-cols-3 gap-2">
          {[250, 500].map((delta) => (
            <button
              ...
              className="min-h-11 radius-control bg-[var(--app-inset)] px-3 type-caption font-semibold text-[var(--app-ink)] ring-1 ring-inset ring-[var(--app-line)] transition-colors active:bg-[var(--app-inset)]"
            >
              +{delta} ml
            </button>
          ))}
          <button
            ...
            className="min-h-11 radius-control bg-[var(--app-inset)] px-3 type-caption font-semibold text-[var(--app-ink-soft)] ring-1 ring-inset ring-[var(--app-line)] transition-colors active:bg-[var(--app-inset)] disabled:opacity-40"
          >
            -250 ml
          </button>
        </div>
      ...
      <div className="mt-4 border-t border-[var(--app-line)] pt-4">
        <div className="mb-2.5 px-1 type-micro font-semibold text-[var(--app-muted)]">
          Micronutrients
        </div>
